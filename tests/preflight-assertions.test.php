...
// config facts unreadable, versions left healthy) reports all eight
// failures, not just the first one found -- same "loud, full picture"
// discipline extended to the new checks.
$result = wpcas_preflight_evaluate(
	array_merge(
		array(
			'pending_count'                     => 0,
