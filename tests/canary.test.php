 ...
 * in docker/wp-cli/measure-admin-page-load.php / measure-manual-run.php
...
// Two canary lines -- both come back, in order.
...
// This ticket's own headline negative case: the manual-run vector calls
