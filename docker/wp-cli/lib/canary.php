 ...
 * #7). Deliberately free of any WordPress/$wpdb/WP-CLI/filesystem
 ...
 * assumed) live in docker/wp-cli/measure-admin-page-load.php and
 * docker/wp-cli/measure-manual-run.php instead, which call into this file.
 *
